...
for positions in daily_transactions:
  split_positions = positions.split('###')
  daily_transactions_split.append(split_positions)
...
for data in daily_transactions_split:
  ...
  for additional_data in data:
    transaction_clean.append(additional_data.replace("\n","").strip(" "))
